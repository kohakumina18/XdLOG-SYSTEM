                    ...
                    <div className="cent">
                        <div className="left">
                            <nav className="dashboard">
                                ...
                                <Link to="/lienlac"><i class="fa-solid fa-calendar-days"></i>Phân công lịch dạy</Link>
                                <Link to="/lienlac"><i class="fa-solid fa-person-chalkboard"></i>Giáo viên trong tổ</Link>
                            </nav>
